...
sbt -java-home "$GRAALVM_HOME" \
  "-Dgatling.js.bundle.filePath=$root_dir/js-simulation/target/bundle.js" \
  "-Dgatling.js.entryPoint=mySimulation" \
  "gatling-jvm-to-js-adapter/Compile/runMain io.gatling.app.Gatling --simulation io.gatling.js.JsSimulation"
