...
@Java2TS(
    declare = {
        ...
        //@Type(value = Metadata.BinaryStreamMarshaller.class, export = true),
        @Type(value = io.grpc.Metadata.Key.class, export = true),
        @Type(value = io.grpc.Status.class, export = true),
        @Type(value = io.grpc.Status.Code.class, export = true),
        ...
        @Type(value = io.gatling.javaapi.grpc.GrpcDynamic.class, export = true),
        @Type(value = io.gatling.javaapi.grpc.GrpcDynamic.FileDescriptorWrapper.class, export = true),
        @Type(value = io.gatling.javaapi.grpc.GrpcDynamic.MethodDescriptorWrapper.class, export = true),
        @Type(value = io.gatling.javaapi.grpc.GrpcDynamic.ServiceDescriptorWrapper.class, export = true),
        ...
        //@Type(value = io.gatling.javaapi.grpc.GrpcStatusCodeCheckBuilder.class, export = true),
        // FIXME private GrpcStatusCodeFinal?
