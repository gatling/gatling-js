...
export interface GrpcProtocolBuilder extends GrpcHeaders<GrpcProtocolBuilder>, ProtocolBuilder {
  ...
  //public GrpcProtocolBuilder channelCredentials(@NonNull Function<Session, ChannelCredentials> credentials) {
  //public GrpcProtocolBuilder channelCredentials(@NonNull String credentials) {
  //public GrpcProtocolBuilder channelCredentials(@NonNull ChannelCredentials credentials) {
